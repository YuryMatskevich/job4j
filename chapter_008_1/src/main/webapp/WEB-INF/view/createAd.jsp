...
<head>
    ...
    <title>Creat a new ad</title>
</head>
<body>
<div class="container">
    <h3 class="text-center">Creating a new ad</h3>
    <form action="${pageContext.servletContext.contextPath}/createAd" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="frame" name="frame">
                <c:forEach items="${applicationScope['frames']}" var="frame">
                    <option value="<c:out value="${frame}"/>"><c:out value="${frame}"/></option>
                </c:forEach>
            </select>
        </div>
        <div class="form-group">
            ...
            <select class="form-control" id="engine" name="engine">
                <c:forEach items="${applicationScope['engines']}" var="engine">
                    <option value="<c:out value="${engine}"/>"><c:out value="${engine}"/></option>
                </c:forEach>
            </select>
        </div>
        <div class="form-group">
            ...
            <select class="form-control" id="transmission" name="transmission">
                <c:forEach items="${applicationScope['transmissions']}" var="transmission">
                    <option value="<c:out value="${transmission}"/>"><c:out value="${transmission}"/></option>
                </c:forEach>
            </select>
        </div>
        <div class="form-group">
            ...
            <select class="form-control" id="manipulator" name="manipulator">
                <c:forEach items="${applicationScope['manipulators']}" var="manipulator">
                    <option value="<c:out value="${manipulator}"/>"><c:out value="${manipulator}"/></option>
                </c:forEach>
            </select>
        </div>
        <div class="form-group">
