...
import ru.job4j.chess.behavior.Elephant;
import ru.job4j.chess.behavior.Tower;
...
//        Cell[] ways = {new Cell("a2"), new Cell("a3"), new Cell("a4"), new Cell("a5"), new Cell("a6"), new Cell("a7"), new Cell("a8")};
